...
The plugin integrates with the DIBS Payment Window method. Refer this page for more information. 
http://www.dibspayment.com/dibs-payment-window
...
2. In the backend, go to Extensions->Plugin Manager and open the DIBS Payment Window plugin
(type = **j2store**).
3. Enable the plugin
